...
namespace DataAccessLayerDBFilm
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="DBFilm")]
    ...
    partial void InsertVideotheque(Videotheque instance);
    partial void UpdateVideotheque(Videotheque instance);
    partial void DeleteVideotheque(Videotheque instance);
    #endregion
		
		public DBFilmDataContext() : 
				base(global::DataAccessLayerDBFilm.Properties.Settings.Default.DBFilmConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<Videotheque> Videotheques
		{
			get
			{
				return this.GetTable<Videotheque>();
			}
		}
	}
	...
	public partial class Requete
	{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_videotheque", DbType="Int NOT NULL")]
		public int videotheque
		{
			get
			{
				return this._videotheque;
			}
			set
			{
				if ((this._videotheque != value))
				{
					this._videotheque = value;
				}
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Videotheque")]
	public partial class Videotheque : INotifyPropertyChanging, INotifyPropertyChanged
	{
